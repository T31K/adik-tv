...
object Constants {
    ...
    // Family TV fleet ids — must match DEVICES in main-server routes/megaflix.js.
    // Sent as `d=` next to the token so the server knows which house is calling
    // (and, later, which TV a remote-assist session targets).
    val MEGAFLIX_DEVICE_IDS = listOf("T_914_WS2", "C_1849292_SB", "M_583_DT", "K_7038_JB")
